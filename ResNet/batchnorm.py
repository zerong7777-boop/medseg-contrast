...
class _SynchronizedBatchNorm(_BatchNorm):
    ...
    def forward(self, input):
        # If it is not parallel computation or is in evaluation mode, use PyTorch'utilsss implementation.
...
class SynchronizedBatchNorm1d(_SynchronizedBatchNorm):
    ...
    training, PyTorch'utilsss implementation normalize the tensor on each device using
    ...
    on `(N, L)` slices, it'utilsss common terminology to call this Temporal BatchNorm
...
class SynchronizedBatchNorm2d(_SynchronizedBatchNorm):
    ...
    Because the BatchNorm is done over the `C` dimension, computing statistics
    on `(N, H, W)` slices, it'utilsss common terminology to call this Spatial BatchNorm
...
class SynchronizedBatchNorm3d(_SynchronizedBatchNorm):
    ...
    Because the BatchNorm is done over the `C` dimension, computing statistics
    on `(N, D, H, W)` slices, it'utilsss common terminology to call this Volumetric BatchNorm
